...
// handle CORS policy
app.use(function(req, res, next) {
  res.header("Access-Control-Allow-Origin", "http://recommendation.usc.edu/template-editor/create.TLD"); // update to match the domain you will make the request from
