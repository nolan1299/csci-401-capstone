...
function onLoad() {
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/form',
        data: {id},
        type: 'GET',
        success: function (data) {
            form = data;
            $.ajax({
                url: 'http://recommendation.usc.edu/template-editor/template',
...
function saveEditModal() {
    ...
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/save',
        data: {
            id: id,
            letter: letterHTML
        },
...
function downloadLetterOLD() {
    ...
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/drive',
        data: {
            id:id,
            letter: letterHTML,
            date: date
        ...
        success: function(d){
            ...
            window.location.href = 'http://recommendation.usc.edu/recommender-dashboard';
        },
        error: function() {
...
function saveLetter() {
    ...
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/templateUpload',
        data: {
            id:id,
            letter: letterHTML,
            formID: idt,
...
function downloadLetter() {
    event.preventDefault();
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/downloads',
        type: 'GET',
        success: function(d) {
            console.log("letter download success");
            window.open('http://recommendation.usc.edu/letter-preview/downloads?foo=bar&xxx=yyy');
        },
        error: function() {
...
function test(){
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/test',
        data: {
            id: id
        },
        type: 'POST',
...
function parseEmailLetter(body) {
    ...
    $.ajax({
        url: 'http://recommendation.usc.edu/email-letter-preview/emailForm',
        data: {id},
        type: 'GET',
        success: function (data) {
            form = data.form;
...
function addEmailHistory() {
    ...
    $.ajax({
        url: 'http://recommendation.usc.edu/letter-preview/addEmailHistory',
        data: {
            id: id,
            Email: Email
        },
        ...
        success: function (data) {
            ...
            window.location.href = 'http://recommendation.usc.edu/history'
        },
        error: function () {
