...
function saveTemplate() {
    ...
    if (id) {
        $.ajax({
            url: 'http://recommendation.usc.edu/template-editor/update',
            data: {
                id: id,
                template: template
            },
            ...
            success: function (data) {
                ...
                window.location.href = 'http://recommendation.usc.edu/template-dashboard'
            },
            error: function (err){
        ...
        $.ajax({
            url: 'http://recommendation.usc.edu/template-editor/create',
